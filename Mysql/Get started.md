...
3. 正则 `REGEXP` `not REGEXP`
   ...
   14. `[]` 表示范围！一个字符为你的表达式内
   15. `\\.` 特殊符号须转义！`[,]` 范围内可不用转义
   16. `\X` 特殊匹配：完整的 Unicode 字符 特殊语言才能使用 | python
